...
function correctAnswerFeedback() {
  ...
  <iframe src="https://giphy.com/embed/26gN16cJ6gy4LzZSw" width="480" height="270" frameBorder="0" class="giphy-embed" alt="10 Points For Gryffindor" allowFullScreen></iframe>  
...
function incorrectAnswerFeedback() {
  ...
  $('.questionAnswerForm').html(`<div role="banner" class="results">
    ...
    <iframe src="https://giphy.com/embed/v1xj1xo2zHz1u" width="480" height="270" frameBorder="0" class="giphy-embed" alt="Try Again" allowFullScreen></iframe>
    <button type="submit" class="nextQuestion">Next Question</button>
    </div>`);
  if (questionNumber <= STORE.length) {
    handleNextQuestion();
...
function generateResults() {
  if (score >= 8) {
    return $('.resultsPage').html(`<header role="banner">
        ...
        <p><iframe src="https://giphy.com/embed/9gc43QEEmxSMM" width="480" height="247" frameBorder="0" class="giphy" alt="Hogwarts Celebration" allowFullScreen></iframe></p>
    ...
    return $('.resultsPage')
      ...
      <p><iframe src="https://giphy.com/embed/LLxwPAjfpLak8" width="480" height="198" frameBorder="0" class="giphy" alt="Voldemort Avada Kedavra" allowFullScreen></iframe></p>
      <h2>You Got ${score} Out Of 10 Correct</h2>
      <button type="submit" class="restartQuiz">Restart Quiz</button>
      </header >`);
  }
